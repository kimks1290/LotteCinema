...
public class NaverLoginBO {
	...
	public final static String CLIENT_ID = "9nPKRgV_rlmJJoB2TCJz";
	public final static String CLIENT_SECRET = "axQZ0wt5PM";
	public final static String REDIRECT_URI = "http://localhost:8080/root/naver/index";
