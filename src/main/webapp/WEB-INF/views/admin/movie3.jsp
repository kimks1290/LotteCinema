...
<body>
	...
	<!-- 영화 리스트 SELECT 태그   -->
	<form action="${contextPath}/admin/modify3"
		enctype="multipart/form-data" method="get">
		<%--id=frm--%>
		<div class="movie-container">
			<label>영화제목:</label> <select id="movie" onChange="SelectRedirect();">
				<option>-- 영화선택 --</option>
				<option value="${movieList[1].price}"
					data-movno="${movieList[1].movNo}">${movieList[1].title}</option>
			</select>
		</div>
		...
		<div class="container">
			...
			<br> <input type="text" name="no" id="invisible"
				value="<%=mval%>"><br> <br>
			<!--이     름  -->
			...
			<input type="text" name="theater" id="invisible"
				value="${info[1].theater}">
			<!-- 상영시간 -->
			<input type="text" name="time" id="invisible" value="${info[1].time}">
			<!-- 아 이 디  -->
