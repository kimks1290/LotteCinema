			...
			<ul class="movie_list">
				<li>
					<div class="top_info">
						<span class="poster_info">
							<img src="https://movie-phinf.pstatic.net/20171205_277/1512458544939cyCUN_JPEG/movie_image.jpg?type=m886_590_2" alt="코코">
					...
					<div class="btm_info">
						<strong class="tit_info">코코 <br></strong>
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${1}">상세정보</a></span>
				...
				<li>
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${2}">상세정보</a></span>
					</div>
				</li>
				<li>
					<div class="top_info">
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${3}">상세정보</a></span>
					</div>
				</li>
				<li>
					<div class="top_info">
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${4}">상세정보</a></span>
					</div>
				</li>
				<li>
					<div class="top_info">
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${5}">상세정보</a></span>
					</div>
				</li>
				<li>
					<div class="top_info">
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${6}">상세정보</a></span>
					</div>
				</li>
				<li>
					<div class="top_info">
					...
					<div class="btm_info">
						...
						<span class="sub_info"><a href="">예매하기</a> &nbsp; <a href="${contextPath }/movie/info?movieNo=${7}">상세정보</a></span>
					</div>
				</li>
			</ul>
		</div>
