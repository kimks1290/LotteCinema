						...
						<div id="tab_1" class="tab_con">
							...
							<div class="member_login_wrap">
								<div class="contents_inner">
									...
									<div class="ad_box">
										<a href=""><img
											src="${path }/resources/image/Witch_450220.jpg" /></a>
									</div>
								</div>
							</div>
						</div>
...
<!-- 											<form action="find_movie" method="post"> -->
												...
												<div class="btn_btm_wrap">
													<a href="#none" class="btn_signup" title="회원가입 페이지 이동">회원가입</a>
													<a type="sumbit" href="#none" class="btn_login_nomem" onclick="openReserve()"
														title="비회원 로그인 페이지 이동">비회원 예매확인</a>
												</div>
											<!-- 	</form> -->
											</div>
										</li>
			...
			<!-- 비회원 로그인 팝업창 종료 -->
			<!-- 비회원 예매 내역 확인 -->
			<div class="nomemLogcheck noMemReservePop">
				<div class="nomemPop">
					<div id="layerLoginNonmem" class="layer_wrap layer_login_nomem">
						<strong class="hidden txtTabIndex">레이어 팝업 시작</strong>
						<div class="layer_contents">
							...
							<div class="inp_lab_wrap">
								...
								<input type="text" id="theater" name="theater" class="ty3" value="" readonly />
								</label> 
								<label class="bx_inp_lab"> 
